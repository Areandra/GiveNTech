            ...
            {fasilitas.map((item, index) => (
              <tr key={item.id} className="border-b hover:bg-gray-50">
                ...
                <td className="px-6 py-3">
                  {editingId === item.id ? (
                    <div>
                      <button onClick={() => handleSave(item.id)} className="mr-2 text-blue-600">
                        Simpan
                      </button>
                      <button onClick={() => setEditingId(null)} className="mr-2 text-yellow-600">
                        Batal
                      </button>
                      <button onClick={() => handleDel(item.id)} className="text-red-600">
                        Hapus
                      </button>
                    </div>
                  ) : (
                    <button onClick={() => handleEditClick(item)} className="text-green-600">
                      Edit
                    </button>
                  )}
                </td>
