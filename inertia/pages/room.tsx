            ...
            <div className="bg-white rounded-xl shadow border border-gray-200 p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-1">
                    {rooms.length > 0 
                      ? Math.round(rooms.reduce((sum: number, room: Room) => sum + (room._count?.bookings || 0), 0) / rooms.length)
                      : 0
                    }
                  </h3>
                </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="font-mono text-gray-900">ROOM-{selectedRoom.id.toString().padStart(3, '0')}</div>
                        </div>
                        <div>
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <button
                            onClick={() => openGoogleMaps(selectedRoom.latitude, selectedRoom.longitude)}
                          ...
                          <button
                            onClick={() => openGoogleMapsDirection(selectedRoom.latitude, selectedRoom.longitude)}
