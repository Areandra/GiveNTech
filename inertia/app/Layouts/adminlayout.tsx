...
export default function AdminLayout({ children }: LayoutProps) {
    ...
    const menu = [
        ...
        { label: 'Fasilitas', icon: <Building2 size={20} />, path: '/admin/fasilitas' },
        { label: 'Bookings', icon: <Calendar size={20} />, path: '/admin/booking' },
    ]
        ...
        <div className="flex min-h-screen bg-gray-100">
            ...
            >
                <div className="flex items-center justify-between p-4 border-b">
                    {open && <h1 className="font-bold text-blue-600 text-lg">Admin Panel</h1>}
